    ...
    <div className="min-h-screen flex" style={{ background: 'linear-gradient(140deg, #f5f7ff 0%, #eef2ff 100%)' }}>
      ...
      >
        ...
        <div className="relative text-center text-white max-w-xs">
          ...
          <h1 className="text-2xl font-extrabold mb-3 tracking-tight">Soutenances ENSPD</h1>
          <p className="text-blue-100/80 text-sm leading-relaxed">
            Votre partenaire pour réussir visuellement votre soutenance de fin d&apos;études.
          </p>
          <div className="mt-8 grid grid-cols-2 gap-3 text-left">
            {['Flyer professionnel', 'Mise en page', 'PowerPoint', 'Livraison rapide'].map((f) => (
              <div key={f} className="flex items-center gap-2 text-sm text-blue-100/80">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-8 py-12">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-8">
            ...
            <h2 className="text-2xl font-extrabold text-text-dark tracking-tight">Bon retour !</h2>
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-text-dark mb-1.5">Adresse email</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-sm font-semibold text-text-dark">Mot de passe</label>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><span className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin" /></div>}>
      <LoginForm />
    </Suspense>
  )
}
